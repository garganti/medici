...
/**
 * Controlla compatibilitï¿½ tra due nodi attraverso il calcolo della differenza di cardinalitï¿½ per l'interesezione
 * return:
 * -1 incompatibili
 *  altrimenti differenza cardinalitï¿½ tra nodo2 e intersezione, 0 significa che nodo2 include nodo1 senza modifiche
 */
